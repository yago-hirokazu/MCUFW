...
extern struct tty_arg *make_argvect(char *line, struct tty_arg *arg);
...
void ttytask(int c)
{
	...
	arg_p = make_argvect(linebuf, arg_p);
	if (arg_p == NULL)
		goto repro;
...
struct tty_arg *make_argvect(char *line, struct tty_arg *arg)
{
